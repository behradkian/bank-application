...
import com.industry.bank.service.adapter.customer.CustomerAdapter;
...
public class CustomerServiceImpl implements CustomerService {
    ...
    public CreateRealCustomerResponseDto createRealCustomer(CreateRealCustomerRequestDto requestDto) throws CustomerExistedException {
        ...
        realCustomerRequest = customerStorage.saveRealCustomerRequest(customerAdapter.adaptRealCustomerRequest(requestDto));
